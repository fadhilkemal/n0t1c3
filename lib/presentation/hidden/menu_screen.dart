    ...
    return new Positioned(
      ...
      child: new Opacity(
        ...
        child: new Container(
          ...
          color: Colors.blue, //!GANTI indicator menu terpilih
        ),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return new InkWell(
      ...
      child: Container(
        width: double.infinity,
        child: new Padding(
          padding: const EdgeInsets.only(left: 40.0, top: 15.0, bottom: 15.0),
          child: new Text(
            title,
            style: new TextStyle(
              color: isSelected
                  ? Color(0xff2F72FC) //!GANTI menu terpilih
                  : Colors.white, //!GANTI menu terpilih
              fontSize: 25.0,
